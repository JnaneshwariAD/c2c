    ...
    >
      ...
      <ListItemWrapper>
        <ListItem alignItems="center">
          <ListItemAvatar>
            ...
            >
              <IconMailbox stroke={1.5} size="1.3rem" color="#03045E" />
      ...
      <ListItemWrapper>
        <ListItem alignItems="center">
          ...
          <ListItemText primary={<Typography variant="subtitle1" sx={{ color: '#03045E' }}>Admin</Typography>} />
          <ListItemSecondaryAction>
            <Grid container justifyContent="flex-end">
              <Grid item xs={12}>
                <Typography variant="caption" display="block" gutterBottom>
      ...
      <ListItemWrapper>
        ...
        <Grid container direction="column" className="list-container">
          ...
          <Grid item xs={12}>
            <Grid container>
              <Grid item>
                <Chip label="Confirmation of Account." sx={{ backgroundColor: '#03045E', color: '#fff' }} />
              </Grid>
            </Grid>
          </Grid>
        </Grid>
