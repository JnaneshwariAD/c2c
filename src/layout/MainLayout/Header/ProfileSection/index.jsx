                ...
                <MainCard border={false} elevation={16} content={false} boxShadow shadow={theme.shadows[16]}>
                  <Box sx={{ p: 2, pb: 0 }}>
                    <Stack direction="row" spacing={0.5} alignItems="center">
                      ...
                      <Typography component="span" variant="h4" sx={{ fontWeight: 600,color:"#03045E" }}>
                        {userName}
                      </Typography>
                    </Stack>
                  </Box>
                  <PerfectScrollbar style={{ height: '100%', maxHeight: 'calc(100vh - 250px)', overflowX: 'hidden' }}>
                    <Box sx={{ p: 2, pt: 0 }}>
                      ...
                      >
                        ...
                        >
                          <ListItemIcon>
                            <IconSettings stroke={1.5} size="1.3rem"  sx={{color:"#03045E"}}/>
                          </ListItemIcon>
                        ...
                        >
                          <ListItemIcon>
                            <IconLogout stroke={1.5} size="1.3rem"  sx={{ color:"#03045E"}}/>
                          </ListItemIcon>
